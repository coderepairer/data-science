...
def answer_one():
    ...
    for i,this_degree in enumerate([1,3,6,9]):
...
def answer_two():
    ...
    for this_degree in range(10):
        ...
        linreg = LinearRegression().fit(X_train_poly, y_train)
        r2_train[this_degree] = r2_score(y_train, linreg.predict(X_train_poly))
        r2_test[this_degree] = r2_score(y_test, linreg.predict(X_test_poly))
